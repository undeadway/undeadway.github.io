...
```
  "dependencies": {
    "my-component-pkg": "git+https://gitee.com/yourname/my-component-pkg#master"
  }
```

然后在 main.js 中 import 一下就可以了。
...
似乎 router.js 中无法直接引用，不知道是本身就不支持还是什么其他原因。