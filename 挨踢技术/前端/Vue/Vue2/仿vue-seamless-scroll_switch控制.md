...
# 仿 vue-seamless-scroll 的 switch 控制切换的走马灯功能

## 前言

这个功能能不能叫走马灯，我也不知道……  
我是仿 `vue-seamless-scroll` 的 `switch控制切换` 功能写的一个
...
[http://codes.waygc.net/vue-wheel/#/carousel](http://codes.waygc.net/vue-wheel/#/carousel)