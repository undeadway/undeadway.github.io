...
当年写代码的时候，pm2 的版本可能还能适应 8.17.0 的 node。
但当时间到了现在，pm2 的默认版本已经升级到了 5.2.2，8.17.0 的 node 已经无法支持部分语法了，所以就报了错。
